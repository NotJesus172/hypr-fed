...
sudo dnf -y in nano curl bash bash-devel wget btop fastfetch firefox kitty samba-client cifs-utils dolphin code tmux sddm starship stow torbrowser-launcher
